				...
				<div className="space-y-5 p-4">
					...
					<section>
						...
						<div className="space-y-1 text-zinc-400">
							...
							<Row label="GAP" desc="Diferencia con el líder. Click en el header para cambiar a INTERVALO (diferencia con el auto de adelante)." />
							...
							<Row label="PACE" desc="Ritmo promedio por stint, excluyendo vueltas de entrada/salida de pits (ver detalle abajo)." />
						</div>
					</section>
					...
					<section>
						<div className="mb-2 text-[11px] uppercase tracking-widest text-zinc-500">
							columna OVT — estado DRS
						</div>
						<div className="space-y-1 text-[12px]">
							<ColorRow color="text-emerald-400" char="DRS" desc="DRS activado — el piloto tiene el alerón trasero abierto." />
							<ColorRow color="text-zinc-500"   char="OVT" desc="DRS disponible — está dentro de 1 segundo del auto de adelante en zona DRS." />
					...
					<section>
						...
						<div className="space-y-1 text-[12px]">
							<ColorRow color="text-violet-400" char="FL"   desc="Fastest Lap — este piloto tiene la vuelta más rápida de la carrera." />
							<ColorRow color="text-emerald-400" char="+N"  desc="Ganó N posiciones respecto a su posición de largada." />
					...
					<section>
						...
						<div className="border border-zinc-800 p-3 text-zinc-400 mb-3">
							...
							<p className="text-[11px] text-zinc-600">
								Stint 1 en blando: promedio 1:15.4 · Stint actual en medio: promedio 1:16.2, degradando +0.04s por vuelta
							</p>
						</div>
						...
						<div className="space-y-1 text-[12px]">
							...
							<p className="text-zinc-400">
								...
								{" — "}media de las vueltas de ritmo del stint (excluye vuelta de salida de pits y vuelta de entrada). El stint actual aparece en <span className="text-zinc-200">blanco</span>, los pasados en <span className="text-zinc-500">gris</span>.
							</p>
							<p className="text-zinc-400">
								<span className="text-zinc-300">Degradación (+/−)</span>
								{" — "}cuántos segundos por vuelta está empeorando (o mejorando) el ritmo dentro del stint. Solo aparece si hay suficientes vueltas. <span className="text-red-500">Rojo</span> = degradación alta, <span className="text-emerald-500">verde</span> = mejorando.
							</p>
					...
					<section>
						...
						<div className="space-y-1 text-[12px]">
							<ColorRow color="text-violet-400" char="█" desc="Más rápido de todos en ese minisector (overall fastest)." />
					...
					<section>
						...
						<div className="space-y-1 text-[12px]">
							...
							<ColorRow color="text-zinc-600"   char="1:18.201" desc="Mejor vuelta de la sesión (si no hay última vuelta)." />
						</div>
					</section>
					...
					<section>
						...
						<div className="space-y-1 text-[12px] text-zinc-400">
							<p><span className="text-violet-400">Violeta</span> — piloto con la vuelta más rápida de la carrera.</p>
							<p><span className="text-sky-400">Azul</span> — piloto marcado como favorito en ajustes.</p>
							<p><span className="text-zinc-600">Opacidad reducida</span> — piloto retirado, detenido o fuera de carrera.</p>
						</div>
					</section>
